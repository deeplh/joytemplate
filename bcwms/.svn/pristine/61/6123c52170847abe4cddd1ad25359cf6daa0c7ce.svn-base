...
@RestController
@RequestMapping(value = "/app/style",method = {RequestMethod.POST,RequestMethod.GET})
public class StyleController {
    ...
    public void updateStyle(@RequestParam(value = "style", required = true) String style,
                            @RequestParam(value = "fileAttrBeanList", required = false) String fileAttrBeanList){
        ...
        styleService.updateStyle(JSONObject.parseObject(style,TblDanceStyle.class),fabl);
    }
}
